...
/*			// create an images/styleX/ folder for each style here.
	...
	public function setup_wizard_header() {
		...
		private function _fetch_remote_file( $url, $post ) {
			...
			$local_file = trailingslashit( get_template_directory() ) . 'images/' . $file_name;
			$upload     = false;
		...
		public function envato_setup_logo_design() {
			...
			<form method="post">
				<p><?php printf( esc_html__( 'Please add your logo below. For best results, the logo should be a transparent PNG. The logo can be changed at any time from the Appearance > Customize area in your dashboard. Try %sEnvato Studio%s if you need a new logo designed.' ), '<a href="http://studiotracking.envato.com/aff_c?offer_id=4&aff_id=1564&source=DemoInstall" target="_blank">', '</a>' ); ?></p>
					...
					if ( count( $my_items ) ) {
						...
						<p>
							<em>On the next page you will be asked to Login with your ThemeForest account and grant
								permissions to enable Automatic Updates.</em>
						</p>
						<p class="envato-setup-actions step">
							<input type="submit" class="button-primary button button-large button-next"
		...
		public function envato_setup_customize() {
			...
			<p>
				Most changes to the website can be made through the Appearance > Theme Options menu from the WordPress
		...
		public function envato_setup_help_support() {
			...
			<p>All new websites created after June 22, 2016 are required by Google to use an API key to access the Google Maps API services. It is recommended for all sites regardless of creation date to add a Google Maps API key.</p>
			<p><strong>To generate your API key that is required for maps to work, please follow this <a href="http://kb.purethemes.net/article/72-create-a-google-maps-api-key" target="_blank">guide</a></strong></p>
			...
			<p>Item Support can be accessed from <a href="https://themeforest.net/item/centum-responsive-wordpress-theme/3216603/support" target="_blank">Support Tab on Items page</a>
				and includes:</p>
			<ul>
		...
		public function envato_setup_ready() {
			...
			<a href="https://twitter.com/share" class="twitter-share-button"
			   data-url="http://themeforest.net/user/purethemes/portfolio?ref=dtbaker"
			...
			<p>Please come back and <a href="http://themeforest.net/downloads" target="_blank">leave a 5-star rating</a>
				if you are happy with this theme. <br/>Follow <a href="https://twitter.com/purethemes" target="_blank">@purethemes</a>
