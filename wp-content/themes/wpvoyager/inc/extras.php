    ...
    ?>
        ...
        <div class="share-icons-container">
            ...
            <ul class="share-icons">
                <?php if (in_array("facebook", $share_options)) { ?><li><a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $url; ?>" title="<?php _e('Share','wpvoyager'); ?>"><i class="fa fa-facebook"></i></a></li> <?php } ?>
                <?php if (in_array("twitter", $share_options)) { ?><li><a href="<?php echo 'https://twitter.com/share?url=' . $url . '&amp;text=' . esc_attr($summary ); ?>" title="<?php _e('Tweet','wpvoyager'); ?>"><i class="fa fa-twitter"></i></a></li><?php } ?>
                ...
                <?php if (in_array("pinterest", $share_options)) { ?><li><a href="<?php echo 'http://pinterest.com/pin/create/button/?url=' . $url . '&amp;description=' . esc_attr($summary) . '&media=' . esc_attr($imageurl); ?>" title="<?php _e('Pin It','wpvoyager'); ?>" onclick="window.open(this.href); return false;"><i class="fa fa-pinterest-p"></i></a></li><?php } ?>
            </ul>
        </div>
...
add_action ( 'post_tag_edit_form_fields', 'wpv_extra_category_fields');
...
function wpv_extra_category_fields( $tag ) {    //check for existing featured ID
    ...
    <tr class="form-field">
        ...
        <select name="wpv_cat_meta[map]" id="wpv_cat_meta[map]" class="postform">
            <option <?php selected( $cat_meta['map'], 'global' ) ?> value="global"><?php _e('Global map (only taxonomy post)','wpvoyager'); ?></option>
            <option <?php selected( $cat_meta['map'], 'none' ) ?> value="none"><?php _e('None','wpvoyager'); ?></option>
            <?php 
...
add_action ( 'edited_post_tag', 'wpv_save_extra_category_fileds');
