    ...
    while ($cpslider_query->have_posts()) : $cpslider_query->the_post();
        ...
        <a href="<?php the_permalink(); ?>" class="item">
            ...
            <div class="title">
                <h2><?php the_title()?></h2>
                <span>
                <?php  if(!$slider['dis_date']) { echo get_the_date(); }?>
                <?php  if(!$slider['dis_date'] && !$slider['dis_author']) { ?>, <?php } ?>
                <?php  if(!$slider['dis_author']) {  ?><?php esc_html_e('by','wpvoyagger'); ?> <?php the_author(); ?><?php } ?>
                </span>
            </div>
