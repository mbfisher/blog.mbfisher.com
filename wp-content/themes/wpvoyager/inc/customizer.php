...
$lmtopmar = ot_get_option( 'pp_mobile_logo_top_margin' );
$lmbotmar = ot_get_option( 'pp_mobile_logo_bottom_margin' );


$taglinemar = ot_get_option( 'pp_tagline_margin' );
$custom_main_color = get_theme_mod('wpvoyager_main_color','#3685cf');
$logo_max_height = ot_get_option('pp_logo_height',25);
$logo_retina_max_height = ot_get_option('pp_logo_mobile_height',25);
...
<style type="text/css">
    ...
    .mobile #logo.logo-image img {
        <?php if ( isset( $lmtopmar[0] ) && $lmtopmar[1] ) { echo 'margin-top:'.$lmtopmar[0].$lmtopmar[1].';'; } ?>
        <?php if ( isset( $lmbotmar[0] ) && $lmbotmar[1] ) { echo 'margin-bottom:'.$lmbotmar[0].$lmbotmar[1].';'; } ?>
    }
    #blogdesc {
