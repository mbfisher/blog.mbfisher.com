...
function custom_theme_options() {
  ...
  $custom_settings = array(
    ...
    'sections'        => array(
      ...
      array(
        'id'          => 'series',
        'title'       => __( 'Post Series', 'wpvoyager' )
      ),   
      array(
        'id'          => 'single_posts',
        'title'       => __( 'Single posts', 'wpvoyager' )
      ), 
      array(
    ...
    'settings'        => array(
        ...
        array(
          'id'          => 'logo_text',
          'label'       => 'Logo Settings',
          'desc'        => 'Settings below are for regular logo that is used if the window/device width is more than 960px.',
          'std'         => '',
        ...
        array(
          'id'          => 'pp_logo_height',
          'label'       => __( 'Maximum Logo Height', 'wpvoyager' ),
          'desc'        => __( 'Set the maximum regular logo height in pixels.', 'wpvoyager' ),
          'std'         => '25',
          'type'        => 'numeric-slider',
          'section'     => 'header',
          'rows'        => '',
        ...
        array(
         ...
         array(
          ...
          'desc'        => 'Settings below are for mobile logo that is used if the window/device width is less than 960px.',
          'std'         => '',
          'type'        => 'textblock_titled',
          'section'     => 'header',
          'rows'        => '',
        ...
        array(
          'id'          => 'pp_logo_mobile_height',
          'label'       => __( 'Maximum Mobile Logo Height', 'wpvoyager' ),
          'desc'        => __( 'Set the maximum mobile logo height in pixels.', 'wpvoyager' ),
          'std'         => '25',
          'type'        => 'numeric-slider',
          'section'     => 'header',
          'rows'        => '',
          ...
          'min_max_step'=> '10,350,1',
           ...
           array(
          'label'       => 'Mobile Logo top margin',
          'id'          => 'pp_mobile_logo_top_margin',
          'type'        => 'measurement',
          'desc'        => 'Set top margin for logo image',
          'std'         => '',
          'rows'        => '',
        ...
        array(
          'label'       => 'Mobile Logo bottom margin',
          'id'          => 'pp_mobile_logo_bottom_margin',
          'type'        => 'measurement',
          'desc'        => 'Set bottom margin for logo image',
          'std'         => '',
          'rows'        => '',
        ...
        array(
          'label'       => 'Archive posts style',
          'id'          => 'pp_archive_posts_style',
          'type'        => 'select',
          'desc'        => '',
          'choices'     => array(
            array('label'  => 'Standard','value' => 'std'),
